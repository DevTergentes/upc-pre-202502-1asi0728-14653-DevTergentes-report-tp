...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.**    | **TB1**<br>**Camila Elena Amaro Villanueva**<br>Ayudé en la elaboración de epics, user stories y technical stories, según necesidades identificadas en segmentos objetivos. Apoyé en la construcción de los impact maps de los dos segmentos.<br><br>**Jherson David Astuyauri Calderon**<br>Participé activamente en la identificación de eventos de dominio mediante event storming, visualizando la lógica del sistema *SecurOn* y comunicando procesos a distintos perfiles del equipo.<br><br>**Claudio Sandro Quispesivana Torres**<br>Contribuí en la definición de segmentos objetivo, análisis de competidores y diseño de entrevistas, fomentando el intercambio de ideas dentro del equipo.<br><br>**Jose Daniel Mario Calderon Huaman**<br>Desarrollé el *startup description* y el *solution profile*, comunicando la propuesta frente a las necesidades del segmento objetivo.<br><br>**Jeremi Jose Antonio Fretel**<br>Participé en la definición de arquetipos, necesidades y journey maps, comunicando los hallazgos para orientar la solución del proyecto.<br><br>**TP1**<br>**Camila Elena Amaro Villanueva**<br>Apoyé en la creación de wireframes y wireflows, exponiendo criterios de accesibilidad y usabilidad al equipo técnico.<br><br>**Jherson David Astuyauri Calderon**<br>Expliqué oralmente el Capítulo V, presentando bounded contexts, arquitectura y diagramas a públicos técnicos y no técnicos.<br><br>**Claudio Sandro Quispesivana Torres**<br>Presenté elementos arquitectónicos, diagramas técnicos y fundamentos de diseño del Capítulo V.<br><br>**Jose Daniel Mario Calderon Huaman**<br>Expuse el *solution profile* y su relación con la propuesta UX, contextualizando para diferentes audiencias.<br><br>**Jeremi Jose Antonio Fretel**<br>Presenté journey maps y justifiqué flujos de diseño, proponiendo mejoras según comentarios del equipo.<br><br>**TB2**<br>**Camila Elena Amaro Villanueva**<br>Presenté el proceso de validación del producto (Capítulo VII), explicando entrevistas y heurísticas aplicadas.<br><br>**Jherson David Astuyauri Calderon**<br>Expliqué configuración del entorno, control de versiones, testing y despliegue, presentando evidencia técnica de la implementación.<br><br>**Claudio Sandro Quispesivana Torres**<br>Presenté resultados de sprints, artefactos técnicos y pipeline de integración y despliegue.<br><br>**Jose Daniel Mario Calderon Huaman**<br>Expuse entrevistas, evaluaciones heurísticas y hallazgos relevantes para la mejora del sistema.<br><br>**Jeremi Jose Antonio Fretel**<br>Presenté el video *About-the-Product*, explicando características clave y resultados de validación.<br><br>**TF1**<br>**Camila Elena Amaro Villanueva**<br>Participé en el *sprint planning* del Sprint 2, definiendo objetivos, story points y asignación de tareas. Generé claridad oral sobre alcance, tiempo y entregables del sprint.<br><br>**Jherson David Astuyauri Calderon**<br>Expliqué la planificación completa del Sprint 2, justificando priorización, dependencias y velocidad del equipo ante el resto de miembros.<br><br>**Claudio Sandro Quispesivana Torres**<br>Comuniqué la estrategia para organizar los tasks del sprint, explicando riesgos y puntos críticos del avance.<br><br>**Jose Daniel Mario Calderon Huaman**<br>Expuse la relación entre objetivos del sprint, hipótesis de validación y entregables UX/negocio.<br><br>**Jeremi Jose Antonio Fretel**<br>Expliqué oralmente los cambios y mejoras planificadas para el Sprint 2, detallando tareas de experiencia de usuario y artefactos a generar. | **TB1:** El equipo demostró comunicación oral clara, colaborativa y orientada a la construcción del sistema desde etapas tempranas, adaptando el discurso según la audiencia.<br><br>**TP:** Las exposiciones técnicas evidenciaron dominio conceptual y capacidad para explicar arquitectura, diseño y UX ante diversos roles del proyecto.<br><br>**TB2:** Las presentaciones sobre validación, implementación y despliegue reforzaron la capacidad del equipo para comunicar hallazgos y decisiones basadas en evidencia.<br><br>**TF:** En el Sprint 2, el equipo consolidó habilidades de comunicación oral al coordinar planificación, priorización y asignación de tareas con claridad, facilitando el entendimiento compartido y la ejecución eficiente. |
| **Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **TB1**<br>**Camila Elena Amaro Villanueva**<br>Organicé tareas relacionadas con user stories basadas en entrevistas, estructurando documentación clara.<br><br>**Jherson David Astuyauri Calderon**<br>Organicé *daily scrums* y documenté partes faltantes del trabajo para priorizar actividades.<br><br>**Claudio Sandro Quispesivana Torres**<br>Coordiné la redacción del diseño táctico, asegurando consistencia entre componentes técnicos.<br><br>**Jose Daniel Mario Calderon Huaman**<br>Desarrollé el *Lean UX Process*, documentando funciones clave y la solución propuesta.<br><br>**Jeremi Jose Antonio Fretel**<br>Elaboré diagramas de flujo y entidades con retroalimentación continua del equipo.<br><br>**TP1**<br>**Camila Elena Amaro Villanueva**<br>Redacté *style guidelines* para mantener coherencia visual en múltiples plataformas.<br><br>**Jherson David Astuyauri Calderon**<br>Documenté el Capítulo V de arquitectura y base de datos.<br><br>**Claudio Sandro Quispesivana Torres**<br>Redacté la estructura principal del Capítulo V, integrando diagramas técnicos.<br><br>**Jose Daniel Mario Calderon Huaman**<br>Desarrollé contenido del Capítulo VI sobre arquitectura de información y UX.<br><br>**Jeremi Jose Antonio Fretel**<br>Documenté wireflows y journey maps del Capítulo VI.<br><br>**TB2**<br>**Camila Elena Amaro Villanueva**<br>Redacté apartados del Capítulo VII sobre validación y análisis de entrevistas.<br><br>**Jherson David Astuyauri Calderon**<br>Redacté documentación de implementación, configuración y despliegue.<br><br>**Claudio Sandro Quispesivana Torres**<br>Documenté pruebas, servicios y detalles técnicos.<br><br>**Jose Daniel Mario Calderon Huaman**<br>Redacté entrevistas, heurísticas y análisis de resultados.<br><br>**Jeremi Jose Antonio Fretel**<br>Redacté el guion y descripción del video *About-the-Product* y edité el Capítulo VII.<br><br>**TF1**<br>**Camila Elena Amaro Villanueva**<br>Redacté el *sprint planning* del Sprint 2, definiendo objetivos, backlog, tareas y estimaciones.<br><br>**Jherson David Astuyauri Calderon**<br>Documenté dependencias técnicas y riesgos del sprint, asegurando trazabilidad escrita.<br><br>**Claudio Sandro Quispesivana Torres**<br>Redacté la descomposición técnica de tasks y criterios de aceptación.<br><br>**Jose Daniel Mario Calderon Huaman**<br>Documenté las justificaciones del sprint y su relación con necesidades de usuario.<br><br>**Jeremi Jose Antonio Fretel**<br>Redacté elementos UX y mejoras planificadas, integrándolos en el backlog del sprint.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | **TB1:** La comunicación escrita fue consistente y permitió documentar con claridad la planificación, necesidades y componentes iniciales del proyecto.<br><br>**TP:** La documentación técnica y UX mostró precisión y coherencia, garantizando entendimiento entre áreas del proyecto.<br><br>**TB2:** El equipo consolidó habilidades avanzadas de documentación en validación, pruebas, arquitectura y despliegue.<br><br>**TF:** La documentación del Sprint 2 reflejó madurez técnica y organizacional, con redacción clara, trazable y alineada al marco Scrum y a los objetivos del producto.                                                                                                                                                            |
...
**Frontend**
<img width="925" height="549" alt="image" src="https://github.com/user-attachments/assets/ee93d6c4-6c22-4c08-8038-19f6d7ee967e" />

**Backend**
<img width="916" height="520" alt="image" src="https://github.com/user-attachments/assets/f72266ac-5a6b-41e8-a32e-04105e8a5eab" />

**Mobile**
<img width="908" height="318" alt="image" src="https://github.com/user-attachments/assets/babacd50-3f67-445c-8963-aa3d0d27890a" />


>**Network**

**Frontend**
<img width="924" height="521" alt="image" src="https://github.com/user-attachments/assets/b26a47df-75ca-4c77-bcd1-1fab5e924f4b" />


**Backend**
<img width="939" height="574" alt="image" src="https://github.com/user-attachments/assets/6cee11e6-4d9b-4291-b47d-4bca80e784af" />


**Mobile**
<img width="943" height="520" alt="image" src="https://github.com/user-attachments/assets/abf56eb5-2932-4fee-b107-cb5759b896f4" />


>**Contributors**

**Frontend**
<img width="917" height="634" alt="image" src="https://github.com/user-attachments/assets/fa7ebaf4-df68-4e9a-840d-88c08358fdc1" />

**Backend**
<img width="930" height="850" alt="image" src="https://github.com/user-attachments/assets/29c214cf-4794-4b60-b1f6-254ffd78e890" />

**Mobile**
<img width="944" height="641" alt="image" src="https://github.com/user-attachments/assets/47d7c547-cc45-4fa3-a93b-31deec5f2fe4" />
