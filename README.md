...
|---|---|---|
| **Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **TB1**<br>**Camila Elena Amaro Villanueva**<br>Ayudé en la elaboración de epics junto con sus respectivas user y technical stories teniendo en cuenta las necesidades identificadas en nuestros segmentos objetivos y los posibles escenarios que podrían presentarse. Asimismo, brindé apoyo en la creación de los impact maps correspondientes a los dos segmentos definidos.<br><br>**Jherson David Astuyauri Calderon**<br>Apoyé activamente a la identificación de eventos de dominio para mejorar la experiencia de usuario durante las interacciones con funciones centrales de nuestro sistema *SecurOn*. Para ello, realizamos un proceso de event storming siguiendo un patrón de pasos preestablecidos que permitió visualizar la lógica correcta del sistema.<br><br>**Claudio Sandro Quispesivana Torres**<br>Participé en la elaboración de los segmentos objetivo, el análisis de competidores y la definición de estrategias frente a ellos. Asimismo, realicé el diseño de entrevistas y el análisis de resultados, fomentando el intercambio de ideas y perspectivas para fortalecer la solución final.<br><br>**Jose Daniel Mario Calderon Huaman**<br>Desarrollé la descripción del startup del equipo y nuestro *solution profile* frente a una necesidad identificada, incluyendo antecedentes y las soluciones que ofrece nuestro producto.<br><br>**Jeremi Jose Antonio Fretel**<br>Contribuí en el desarrollo de los arquetipos de usuarios y en la definición de sus necesidades principales, lo que permitió orientar mejor el diseño de soluciones dentro del proyecto. Además, colaboré en la preparación de los journey maps para visualizar las experiencias de los usuarios en diferentes etapas del proceso.<br><br>**TP1**<br>**Camila Elena Amaro Villanueva**<br>Apoyé en la creación de los wireframes del mobile app y en los wireflows derivados, exponiendo oralmente los principios de usabilidad y accesibilidad aplicados al diseño durante las reuniones técnicas del Capítulo VI.<br><br>**Jherson David Astuyauri Calderon**<br>Presenté de forma oral el Capítulo V (Diseño táctico del software), explicando la estructura de los bounded contexts IAM, Management y Records; expuse diagramas de componentes y clases y adapté el lenguaje según el público (diseñadores, frontend, backend).<br><br>**Claudio Sandro Quispesivana Torres**<br>Expuse los fundamentos arquitectónicos y los diagramas técnicos (componentes, clases, base de datos) del Capítulo V, explicando la separación de responsabilidades y las implicancias para el desarrollo.<br><br>**Jose Daniel Mario Calderon Huaman**<br>Expliqué oralmente el solution profile y cómo la propuesta UX respalda las funcionalidades definidas en los bounded contexts, aportando contexto de negocio para audiencias técnicas y no técnicas.<br><br>**Jeremi Jose Antonio Fretel**<br>Presenté los journey maps y justifiqué las decisiones de flujo, mostrando cómo los wireflows responden a las necesidades identificadas y proponiendo mejoras tras la retroalimentación del equipo.<br><br>**TB2**<br>**Camila Elena Amaro Villanueva**<br>Presenté el proceso de validación del producto en el Capítulo VII, explicando cómo se diseñaron las entrevistas y las heurísticas aplicadas para evaluar la usabilidad del sistema. Además, mostré los resultados cualitativos y observaciones de usuarios durante la revisión con el equipo.<br><br>**Jherson David Astuyauri Calderon**<br>Expliqué oralmente las configuraciones del entorno de desarrollo, control de versiones y despliegue de la solución *SecurOn*, exponiendo la arquitectura del repositorio y los lineamientos de estilo del código. Presenté la evidencia de implementación, testing suite y despliegue, adaptando el discurso para audiencias técnicas y académicas.<br><br>**Claudio Sandro Quispesivana Torres**<br>Participé en la exposición de los resultados de los sprints y presenté los artefactos de documentación técnica y servicios desplegados. Además, lideré la comunicación del pipeline de integración y despliegue, garantizando comprensión técnica por parte del equipo.<br><br>**Jose Daniel Mario Calderon Huaman**<br>Expuse el proceso de diseño y registro de entrevistas de validación, detallando los criterios aplicados y los hallazgos observados. También presenté las evaluaciones heurísticas y las conclusiones obtenidas a partir de la retroalimentación del público objetivo.<br><br>**Jeremi Jose Antonio Fretel**<br>Apoyé la exposición del video *About-the-Product*, explicando las principales características visuales y funcionales del sistema. Además, participé en la comunicación oral de los resultados de validación y mejoras tras las entrevistas. <br><br>**TF1**<br>**Camila Elena Amaro Villanueva**<br>Forme parte de la reunión de sprint planning para el sprint 2, donde se plantearon los objetivos para el sprint, la velocidad que tendría y el número de story points que lo conformarían. Asimismo, esto me ayudo a poder identificar las user y technical stories que conformarían el sprint, así como sus respectivos tasks y el tiempo quién se encontraba asignado a cada entregable. | **TB1:** El equipo trabajó de forma colaborativa en todas las etapas iniciales de *SecurOn*, desde la definición del problema hasta la construcción de la solución tecnológica, asegurando una comunicación oral clara y estratégica.<br><br>**TP:** Durante los capítulos V y VI se fortaleció la comunicación técnica con públicos diversos (diseño, frontend, backend, negocio), logrando exposiciones claras, adaptadas y efectivas.<br><br>**TB2:** Las exposiciones se centraron en la implementación, validación y despliegue, evidenciando dominio técnico y claridad en la comunicación con docentes y evaluadores externos. |
| **Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **TB1**<br>**Camila Elena Amaro Villanueva**<br>Participé en la planificación del proyecto y me encargué de organizar las tareas relacionadas con la elaboración de las user stories, basándome en la información recopilada en entrevistas a los segmentos objetivo.<br><br>**Jherson David Astuyauri Calderon**<br>Organicé reuniones *daily scrum*, identificando partes faltantes del trabajo y priorizando tareas pendientes para asegurar el avance constante del proyecto.<br><br>**Claudio Sandro Quispesivana Torres**<br>Contribuí a la creación de un entorno colaborativo y coordiné la redacción del diseño táctico, asegurando coherencia entre capas y cumplimiento de plazos.<br><br>**Jose Daniel Mario Calderon Huaman**<br>Desarrollé el *Lean UX Process*, identificando funciones clave, segmentos objetivo y la solución frente a la problemática detectada.<br><br>**Jeremi Jose Antonio Fretel**<br>Apoyé en la validación de requerimientos técnicos y funcionales, elaborando diagramas de flujo y entidades del sistema con retroalimentación continua.<br><br>**TP1**<br>**Camila Elena Amaro Villanueva**<br>Organicé la sección de *style guidelines* del Capítulo VI, definiendo criterios de coherencia visual entre plataformas.<br><br>**Jherson David Astuyauri Calderon**<br>Redacté el Capítulo V, documentando capas, diagramas y base de datos con objetividad técnica.<br><br>**Claudio Sandro Quispesivana Torres**<br>Fui responsable de la redacción principal del Capítulo V, garantizando claridad y consistencia entre los diagramas técnicos.<br><br>**Jose Daniel Mario Calderon Huaman**<br>Redacté la descripción de la solución UX (Capítulo VI), desarrollando la arquitectura de información y estructura de contenido.<br><br>**Jeremi Jose Antonio Fretel**<br>Elaboré los wireflows y journey maps del Capítulo VI, describiendo comportamientos y rutas de usuario con precisión.<br><br>**TB2**<br>**Camila Elena Amaro Villanueva**<br>Redacté los apartados del Capítulo VII sobre validación del producto, diseño de entrevistas y análisis de resultados. Documenté observaciones y mejoras con objetividad.<br><br>**Jherson David Astuyauri Calderon**<br>Redacté las secciones de *Software Configuration Management*, *Solution Implementation* y *Deployment*, asegurando claridad técnica y trazabilidad en la documentación.<br><br>**Claudio Sandro Quispesivana Torres**<br>Documenté los apartados técnicos de implementación, pruebas y servicios desplegados, garantizando precisión técnica y consistencia con etapas previas.<br><br>**Jose Daniel Mario Calderon Huaman**<br>Redacté las entrevistas de validación y análisis de heurísticas de usabilidad, relacionando los resultados con las hipótesis iniciales.<br><br>**Jeremi Jose Antonio Fretel**<br>Redacté la sección del video *About-the-Product* y apoyé en la edición general del Capítulo VII para unificar estilo y estructura. <br><br>**TF1**<br>**Camila Elena Amaro Villanueva**<br>Redacté el sprint planning para el sprint 2, en el cual se realizó una revisión al sprint 1 para poder verificar si se lograron las metas planteadas y estimar los nuevos objetivos para el sprint, al igual que las sotries que lo conformarían. Además, apoyé en la creación del sprint backlog, donde se considero las user y technical stories faltantes que fueran necesarias para la solución, de ese modo se los dividió por tasks y se les asigno una estimación de horas y un miembro encargado de realizarla. | **TB1:** El equipo demostró una comunicación escrita sólida y organizada, con trazabilidad y coherencia en la planificación y documentación del proyecto.<br><br>**TP:** La documentación técnica y de UX/UI fue objetiva y accesible, asegurando integración entre diseño y desarrollo.<br><br>**TB2:** El equipo consolidó sus habilidades de redacción técnica en el Capítulo VII, documentando implementación, validación y despliegue con precisión, claridad y rigor profesional. |
...
| **Sprint 0 – Review Summary** | No aplica al ser el primer sprint de implementación sobre la base ya desplegada. |
...
|  |  | T13 | Disparar notificación  | Alertar a transportistas calificados | 6 | Camila | **Done** |
| TS01 | Endpoint GET estado vehículo | T14 | Implementar GET /api/vehicle-monitoring/{vehicleId}   | 4 | Claudio | **Done** |
|  |  | T15 | Manejo de error del endpoint | Respuestas 404/500 + mensaje técnico de error | 3 | Camila | **Done** |
